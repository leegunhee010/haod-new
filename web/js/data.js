...
(function () {
  ...
  var DEFAULT_COPY = [
    ...
    { key: "gcard1_d", page: "index", sel: "#gcarTrack .gcard:nth-of-type(1) .gcard__d", tag: "b", label: "전략카드① — 설명", value: "키워드·메타·속도·구조화 데이터까지, 네이버·구글이 좋아하는 기술 구조로 검색 상위노출을 설계합니다." },
    { key: "gcard2_t", page: "index", sel: "#gcarTrack .gcard:nth-of-type(2) .gcard__t", tag: "b", label: "전략카드② — 제목", value: "AEO · GEO" },
    { key: "gcard2_d", page: "index", sel: "#gcarTrack .gcard:nth-of-type(2) .gcard__d", tag: "b", label: "전략카드② — 설명", value: "ChatGPT·Gemini·Perplexity가 답변에 우리 브랜드를 인용하도록 신뢰 신호와 답변형 콘텐츠를 설계합니다." },
    { key: "gcard3_t", page: "index", sel: "#gcarTrack .gcard:nth-of-type(3) .gcard__t", tag: "b", label: "전략카드③ — 제목", value: "반응형 홈페이지" },
    { key: "gcard3_d", page: "index", sel: "#gcarTrack .gcard:nth-of-type(3) .gcard__d", tag: "b", label: "전략카드③ — 설명", value: "기업·병원·브랜드 사이트부터 랜딩·쇼핑몰·관리자까지. 디자인·퍼블리싱·개발을 한 팀이 책임집니다." },
    { key: "gcard4_t", page: "index", sel: "#gcarTrack .gcard:nth-of-type(4) .gcard__t", tag: "b", label: "전략카드④ — 제목", value: "모바일 앱·시스템" },
    { key: "gcard4_d", page: "index", sel: "#gcarTrack .gcard:nth-of-type(4) .gcard__d", tag: "b", label: "전략카드④ — 설명", value: "iOS·Android·웹앱부터 결제·예약·API 연동, 백엔드·보안까지 안정적으로 구축합니다." },
    { key: "gcard5_t", page: "index", sel: "#gcarTrack .gcard:nth-of-type(5) .gcard__t", tag: "b", label: "전략카드⑤(진단) — 제목", value: "무료 SEO 진단" },
    { key: "gcard5_d", page: "index", sel: "#gcarTrack .gcard:nth-of-type(5) .gcard__d", tag: "b", label: "전략카드⑤(진단) — 설명", value: "URL만 넣으면 22개 항목을 100점 만점으로 진단. 우리 홈페이지 SEO 점수, 지금 바로 확인해 보세요." },
    { key: "gcard6_t", page: "index", sel: "#gcarTrack .gcard:nth-of-type(6) .gcard__t", tag: "b", label: "전략카드⑥ — 제목", value: "유지보수·운영" },
    { key: "gcard6_d", page: "index", sel: "#gcarTrack .gcard:nth-of-type(6) .gcard__d", tag: "b", label: "전략카드⑥ — 설명", value: "오픈 후 수정·보안·성능 점검과 검색 성과 모니터링까지. 만든 뒤에도 계속 발견되게 함께합니다." },
