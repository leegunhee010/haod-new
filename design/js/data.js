...
(function () {
  ...
  var DEFAULT_FAQ = {
    catalog: [
      { q: "카탈로그 제작 기간은 얼마나 걸리나요?",
        a: "분량과 촬영 포함 여부에 따라 다르지만, 기획·디자인·인쇄까지 보통 2~4주가량 소요됩니다. 일정이 급하시면 상담 시 알려주세요 — 가능 범위를 먼저 안내드립니다." },
      { q: "제작 비용은 어떻게 산정되나요?",
        a: "페이지 수, 인쇄 수량, 후가공(코팅·박·형압 등), 촬영 포함 여부에 따라 산정됩니다. 사양을 알려주시면 무료로 견적을 안내드립니다." },
      { q: "디자인만 의뢰하고 인쇄는 따로 진행해도 되나요?",
        a: "네, 디자인만 의뢰하셔도 됩니다. 다만 디자인부터 인쇄까지 원스톱으로 진행하시면 색 보정과 후가공 품질까지 한 팀이 관리해 결과물 완성도가 높아집니다." },
      { q: "제품 사진 촬영도 함께 가능한가요?",
        a: "네. 자체 촬영 서비스를 운영해 제품·연출 컷을 촬영하고 바로 디자인에 반영합니다. 촬영과 디자인을 따로 맡길 때 생기는 톤 차이가 없습니다." },
      { q: "시안 수정은 몇 회까지 가능한가요?",
        a: "시안 확정 전까지 협의를 통해 수정을 진행합니다. 만족할 때까지 완성도로 답한다는 원칙으로 작업합니다." },
    ],
    leaflet: [
      { q: "리플렛 제작 기간은 얼마나 걸리나요?",
        a: "구성과 수량에 따라 다르지만 디자인부터 인쇄까지 보통 1~2주가량 소요됩니다. 행사 일정이 정해져 있다면 상담 시 알려주세요." },
      { q: "접지 방식은 어떻게 정하나요?",
      ...
      { q: "원고가 정리되어 있지 않은데 기획부터 맡길 수 있나요?",
        a: "가능합니다. 전달할 핵심 메시지와 자료를 주시면 정보의 순서와 구성 기획부터 함께 진행합니다." },
      { q: "팜플렛과 리플렛 중 어떤 걸 만들어야 하나요?",
        a: "담을 정보량과 배포 방식에 따라 다릅니다. 상담 시 용도를 알려주시면 접지 방식과 사이즈까지 알맞은 형태를 제안드립니다." },
    ],
    poster: [
      { q: "포스터 사이즈는 어떤 걸 선택해야 하나요?",
  ...
  var DEFAULT_SEOALT = {
    catalog: { alt: "카탈로그 제작은 카다로그 제작 · 카달로그 제작으로, 브로슈어 디자인은 브로셔 제작으로도 많이 검색됩니다. 어떤 표기로 찾아오셔도 회사소개서 · 제품 카탈로그 · 기업 브로슈어를 만드는 같은 서비스입니다. 하오디자인은 카탈로그 제작 업체이자 인쇄물 디자인 업체로서 편집디자인부터 인쇄까지 한 번에 진행합니다.",
      kw: "카탈로그 제작, 카다로그, 카달로그, 브로슈어 제작, 브로셔, 카탈로그 디자인, 카탈로그 제작 업체, 회사소개서 디자인, 인쇄물 디자인 업체, 홍보물 제작 업체, 편집디자인" },
    leaflet: { alt: "리플렛 제작은 리플릿 제작 · 리플릿 디자인으로, 팜플렛 제작은 팜플릿 제작 · 팸플릿 제작으로도 검색됩니다. 표기는 달라도 2단 · 3단 접지 인쇄물을 만드는 같은 서비스입니다. 하오디자인은 팜플렛 · 리플렛 제작 업체로서 홍보물 디자인부터 인쇄까지 함께합니다.",
      kw: "리플렛 제작, 리플릿, 팜플렛 제작, 팜플릿, 팸플릿, 리플렛 디자인, 3단 리플렛, 접지 인쇄, 홍보물 제작 업체, 인쇄물 디자인" },
    poster: { alt: "포스터 제작은 포스터 디자인 · 포스터 인쇄로, 전단지 제작은 전단 제작 · 전단 인쇄 · 전단지 디자인으로도 검색됩니다. 하오디자인은 행사 · 홍보 인쇄물 디자인 업체로서 포스터와 전단지를 디자인부터 인쇄 · 납품까지 진행합니다.",
      kw: "포스터 제작, 포스터 디자인, 포스터 인쇄, 전단지 제작, 전단 인쇄, 전단지 디자인, 행사 포스터, 홍보물 제작 업체" },
    ci: { alt: "로고 제작은 로고 디자인 업체 · 로고제작업체 · CI 제작 · BI 디자인으로도 검색됩니다. 회사 로고, 브랜드 로고, 심볼 마크까지 — 하오디자인은 CI · 로고 디자인 업체로서 명함 · 서식 응용 시스템까지 함께 만듭니다.",
      kw: "로고 제작, 로고 디자인 업체, 로고제작업체, CI 디자인, BI 디자인, 회사 로고 제작, 심볼 로고, 명함 디자인" },
    package: { alt: "패키지 디자인은 패키지 제작 업체 · 박스 디자인 · 단상자 제작 · 포장지 디자인으로도 검색됩니다. 라벨 제작은 라벨 디자인 · 스티커 제작과 같은 서비스로, 하오디자인은 패키지 · 라벨 인쇄 전문 업체로서 구조 설계부터 양산까지 함께합니다.",
      kw: "패키지 디자인, 패키지 제작 업체, 단상자 제작, 박스 디자인, 포장지 디자인, 라벨 디자인, 스티커 제작, 쇼핑백 제작" },
    global: { alt: "다국어 카탈로그 제작은 영문 카탈로그 제작 · 영문 카다로그 · 영문 브로셔 제작 · 중문 카탈로그 · 일문 카탈로그로도 검색됩니다. 하오디자인은 수출용 인쇄물 디자인 업체로서 영어 · 중국어 · 일본어 · 프랑스어 다국어 편집을 원스톱으로 진행합니다.",
