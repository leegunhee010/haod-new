/* ===================================================
   HAO COMMUNICATION — shared data layer
...
(function () {
  ...
  var DEFAULT_POSTS = [
    {
      ...
      body: [
        ...
        "하오커뮤니케이션은 회사소개서를 만들 때 항상 '첫 페이지 시안'부터 잡습니다. 첫 장의 방향이 정해지면 나머지 페이지의 톤과 구조는 자연스럽게 따라옵니다. 회사소개서 리뉴얼을 고민 중이라면, 지금 쓰고 있는 소개서의 첫 페이지를 다시 펼쳐보세요."
      ]
    },
    {
    ...
    },
    {
      ...
      body: [
        ...
        "전시 · 포럼 · 공연 포스터 제작을 준비 중이라면, 전하고 싶은 메시지 딱 하나만 정해서 와주세요. 나머지는 하오커뮤니케이션이 설계합니다."
      ]
    }
  ];
  ...
  var DEFAULT_SEO = {
    ...
    pages: {
      index: {
        title: "하오커뮤니케이션 | 카탈로그·브로슈어·포스터·리플렛 제작 디자인",
        desc: "카탈로그·브로슈어·포스터·리플렛 디자인부터 인쇄·사진촬영까지. 10년 경력의 디자이너가 함께하는 원스톱 디자인 스튜디오, 하오커뮤니케이션(HAO COMMUNICATION).",
        keywords: "카탈로그제작, 브로슈어제작, 회사소개서제작, 리플렛제작, 포스터제작, 인쇄디자인, 편집디자인, 하오커뮤니케이션" },
      about: {
        title: "회사소개 | 하오커뮤니케이션 HAO COMMUNICATION",
        desc: "2013년부터 카탈로그·브로슈어·포스터·리플렛 인쇄 디자인 한 길. 기획·디자인·촬영·인쇄·납품까지 원스톱으로 제공하는 디자인 스튜디오 하오커뮤니케이션.",
        keywords: "하오커뮤니케이션, 디자인스튜디오, 인쇄디자인회사, 편집디자인, 광진구 디자인" },
      service: {
        title: "서비스 | 카탈로그·브로슈어·포스터·CI·패키지·촬영 | 하오커뮤니케이션",
      ...
      work: {
        title: "포트폴리오 | 하오커뮤니케이션 제작 사례",
        desc: "하오커뮤니케이션이 직접 기획·제작한 카탈로그·브로슈어·리플렛·포스터·CI·패키지·촬영·다국어 디자인 실제 작업 사례 모음.",
        keywords: "카탈로그 포트폴리오, 브로슈어 사례, 회사소개서 디자인, 인쇄물 제작 사례, 하오커뮤니케이션 포트폴리오" },
      board: {
        title: "칼럼 | 인쇄와 디자인 이야기 | 하오커뮤니케이션",
        desc: "카탈로그·브로슈어·인쇄 디자인을 준비할 때 알아두면 좋은 실무 이야기. 하오커뮤니케이션의 디자인 칼럼.",
        keywords: "인쇄 가이드, 카탈로그 제작 팁, 회사소개서 기획, 디자인 칼럼, 인쇄 데이터" },
      support: {
        title: "정부지원사업 | 수출바우처·제조혁신바우처 디자인 제작 | 하오커뮤니케이션",
        desc: "수출바우처·제조혁신바우처·소상공인 지원사업 공식 수행기관 하오커뮤니케이션. 정부지원사업으로 카탈로그·브로슈어·다국어 홍보물 제작 비용 부담을 줄이세요.",
        keywords: "수출바우처, 제조혁신바우처, 정부지원사업 디자인, 바우처 카탈로그, 소상공인 지원사업, 수출바우처 수행기관" },
      contact: {
        title: "견적문의 | 하오커뮤니케이션 HAO COMMUNICATION",
        desc: "카탈로그·브로슈어·포스터·리플렛 제작 견적 문의. 간단한 내용만 남겨주시면 담당자가 빠르게 연락드립니다. 1666-2027",
        keywords: "디자인 견적, 카탈로그 견적, 브로슈어 견적, 인쇄 견적 문의, 하오커뮤니케이션 문의" }
    }
  };
  ...
  var DEFAULT_COPY = [
    ...
    { key: "intro_words", page: "index", sel: ".intro__words", tag: "em", label: "인트로 문장",
      value: "예쁘기만 한 디자인이 아니라, 브랜드의 메시지를 정확히 전달하고 **실제 성과로 이어지는 디자인.** 그것이 하오커뮤니케이션이 일하는 방식입니다." },
    ...
    { key: "work_lead", page: "index", sel: ".work__lead", tag: "b", label: "제작 사례 설명",
      value: "하오커뮤니케이션이 직접 기획하고 완성한 실제 작업물입니다." },
    { key: "reviews_title", page: "index", sel: ".reviews__head h2", tag: "b", label: "고객 후기 제목",
      value: "다시 찾아주시는 이유" },
    { key: "intro_tag", page: "index", sel: ".intro .section-tag", tag: "b", label: "인트로 — 섹션 태그", value: "WHY HAO COMMUNICATION" },
    ...
    { key: "svc7_n", page: "index", sel: ".svc-list .svc:nth-child(6) .svc__name", tag: "b", label: "서비스⑥ 이름", value: "다국어디자인" },
    { key: "svc7_t", page: "index", sel: ".svc-list .svc:nth-child(6) .svc__tags", tag: "b", label: "서비스⑥ 부가", value: "영문 · 중문 수출용" },
    ...
    { key: "partners_title", page: "index", sel: ".partners__head h2", tag: "b", label: "파트너 — 제목", value: "고객과 함께 걸어가는 하오커뮤니케이션" },
    ...
    { key: "ab_p1", page: "about", sel: ".astory__body p:nth-of-type(1)", tag: "b", label: "스토리 — 본문 1문단",
      value: "하오커뮤니케이션은 2013년부터 카탈로그 · 브로슈어 · 포스터 · 리플렛 등 인쇄 디자인 한 길을 걸어왔습니다. 화면 속 디자인이 넘쳐나는 시대에도, 손에 잡히는 종이 한 장이 만들어내는 신뢰의 무게는 다르다고 믿기 때문입니다." },
    { key: "ab_p2", page: "about", sel: ".astory__body p:nth-of-type(2)", tag: "b", label: "스토리 — 본문 2문단",
      value: "우리는 디자인만 하고 끝내지 않습니다. 기획과 카피, 사진촬영, 인쇄와 후가공, 납품까지 — 결과물이 손에 쥐어지는 마지막 순간까지 하나의 팀이 책임집니다. 그래서 하오커뮤니케이션의 작업에는 공정 사이의 어긋남이 없습니다." },
    ...
    { key: "hw_title", page: "about", sel: ".hway__title", tag: "em", label: "일하는 방식 — 제목", value: "하오커뮤니케이션은\n다릅니다" },
    ...
    { key: "hw_p4p", page: "about", sel: ".hway__panel:nth-child(4) p", tag: "b", label: "일하는 방식 — 패널④ 내용",
      value: "수정 횟수에 쫓기지 않습니다.\n고객의 만족과 결과의 완성도가 하오커뮤니케이션의 기준입니다." },
    ...
    { key: "vc_title", page: "support", sel: "main > section:nth-of-type(3) .page__title", tag: "b", label: "분야 — 제목", value: "하오커뮤니케이션 지원사업 분야" },
    ...
    { key: "fq5_a", page: "support", sel: ".faq .faq__item:nth-of-type(5) .faq__a p", tag: "b", label: "FAQ⑤ 답변",
      value: "사업 종료 후 진행되는 결과보고 역시 평가 기준과 작성 요건을 정확히 이해하는 것이 중요합니다. 하오커뮤니케이션은 항목별 작성 기준과 필수 포함 내용에 대한 명확한 가이드를 제공합니다. 결과보고 완성도를 높이고 싶다면, 전문 컨설팅을 통해 방향을 점검해보시기 바랍니다." },
  ...
  var DEFAULT_SERVICE = {
    catalog: { label: "카탈로그 · 브로슈어", eng: "CATALOG & BROCHURE", c: "카탈로그·브로슈어",
      ...
      head: "좋은 카탈로그는\n설명보다 설득에 가깝습니다",
      seoTitle: "카탈로그 제작·브로슈어 디자인 | 회사소개서 편집디자인 | 하오커뮤니케이션",
      seoDesc: "회사소개서·제품 카탈로그·브로슈어 편집디자인부터 인쇄·후가공까지 원스톱. 기획·디자인·제작을 한 팀이 책임지는 하오커뮤니케이션 카탈로그 제작 서비스.",
      seo: { h: "카탈로그제작 · 브로슈어제작",
        t1: "카탈로그 및 브로슈어에 대하여",
        ...
        p2: "카탈로그 제작이나 브로슈어 디자인을 준비할 때는 먼저 목적과 타깃을 명확히 설정하고, 그에 맞는 구성과 페이지 수를 기획하는 것이 중요합니다. 디자인 단계에서는 브랜드 아이덴티티에 맞는 레이아웃과 색상을 적용하고, 인쇄 단계에서는 종이 재질과 후가공(코팅, 박, 제본 등)을 신중히 선택해야 완성도가 높아집니다. 하오커뮤니케이션은 회사소개서, 제품 카탈로그, 기업 브로슈어까지 기획부터 납품까지 원스톱으로 진행합니다." } },
    leaflet: { label: "팜플렛 · 리플렛", eng: "PAMPHLET & LEAFLET", c: "리플렛",
      desc: "펼치고 접는 흐름까지 계산한 리플렛 — 작은 지면에 핵심만 담습니다.",
      head: "접는 순간까지\n설계된 한 장",
      seoTitle: "팜플렛·리플렛 제작 | 2단·3단 접지 리플렛 디자인 | 하오커뮤니케이션",
      seoDesc: "행사·매장·제품 안내 팜플렛·리플렛 제작. 2단·3단·대문접지 등 목적에 맞는 리플렛 디자인과 인쇄를 하오커뮤니케이션이 원스톱으로 제작합니다.",
      seo: { h: "팜플렛제작 · 리플렛제작",
        t1: "팜플렛 및 리플렛에 대하여",
        ...
        t2: "팜플렛 및 리플렛 준비 방법",
        p2: "팜플렛 제작을 준비할 때는 배포 장소와 대상, 전달할 핵심 메시지를 먼저 정해야 합니다. 접지 방식(2단 · 3단 · 대문접지)에 따라 정보의 순서가 달라지므로 구성 기획이 중요하고, 용지 평량과 코팅 여부에 따라 손에 닿는 인상이 달라집니다. 하오커뮤니케이션은 소량 디지털 인쇄부터 대량 옵셋 인쇄까지 목적과 수량에 맞는 팜플렛 · 리플렛 제작을 제안해드립니다." } },
    poster: { label: "포스터 · 전단지", eng: "POSTER & FLYER", c: "포스터·전단지",
      desc: "멀리서도 읽히는 위계와 임팩트 — 목적에 맞는 포스터 · 전단지를 만듭니다.",
      head: "지나가는 3초를\n붙잡는 한 장",
      seoTitle: "포스터 제작·전단지 디자인 | 행사·홍보 포스터 인쇄 | 하오커뮤니케이션",
      seoDesc: "행사·공연·모집 포스터, 판촉 전단지 제작. 멀리서도 읽히는 포스터 디자인부터 인쇄·납품까지 하오커뮤니케이션이 한 번에 진행합니다.",
      seo: { h: "포스터제작 · 전단지제작",
        t1: "포스터 및 전단지에 대하여",
        ...
        t2: "포스터 및 전단지 준비 방법",
        p2: "포스터 디자인을 준비할 때는 부착 장소와 보는 거리를 먼저 고려해 사이즈(A3~A0)와 글자 크기를 정해야 합니다. 전단지 제작은 배포 수량과 방식에 따라 용지와 인쇄 방식(디지털 · 옵셋)을 선택하면 비용을 효율적으로 줄일 수 있습니다. 하오커뮤니케이션은 목적에 맞는 카피 위계 설계부터 인쇄 · 납품까지 한 번에 진행합니다." } },
    ci: { label: "CI · 로고디자인", eng: "CI & LOGO", c: "CI·로고디자인",
      desc: "브랜드의 방향을 담은 CI · 로고 — 명함부터 서식류까지 일관되게 확장합니다.",
      head: "로고는 회사의\n첫 문장입니다",
      seoTitle: "로고 제작·CI 디자인 | 브랜드 로고·명함 디자인 | 하오커뮤니케이션",
      seoDesc: "회사 로고 제작과 CI 디자인. 명함·서식 등 기본 응용 시스템과 인쇄·온라인 겸용 파일까지 제공하는 하오커뮤니케이션 브랜딩 서비스.",
      seo: { h: "로고제작 · CI디자인",
        t1: "로고 및 CI에 대하여",
        ...
        t2: "로고 및 CI 준비 방법",
        p2: "로고 제작을 의뢰할 때는 회사 소개와 지향하는 방향, 선호하는 레퍼런스를 정리해 전달하면 시안의 정확도가 높아집니다. 완성된 로고는 AI 원본과 인쇄 · 온라인 겸용 파일로 제공받아야 명함 제작, 홍보물 제작에 바로 활용할 수 있습니다. 하오커뮤니케이션은 로고 디자인부터 기본 응용 시스템, 사용 가이드까지 함께 정리해드립니다." } },
    package: { label: "패키지 · 라벨", eng: "PACKAGE & LABEL", c: "패키지·라벨",
      desc: "제품의 가치를 그대로 전하는 패키지 · 라벨 디자인.",
      head: "선반 위에서\n먼저 말을 거는 디자인",
      seoTitle: "패키지 디자인·라벨 제작 | 단상자·스티커 디자인 | 하오커뮤니케이션",
      seoDesc: "단상자·라벨·스티커·쇼핑백 등 패키지 디자인 제작. 구조 설계부터 재질·후가공, 소량 제작과 양산까지 하오커뮤니케이션이 함께합니다.",
      seo: { h: "패키지디자인 · 라벨제작",
        t1: "패키지 및 라벨에 대하여",
        ...
        t2: "패키지 및 라벨 준비 방법",
        p2: "패키지 제작을 준비할 때는 제품 실물 또는 정확한 치수와 함께 식품 · 화장품 등 품목별 표시사항 문구를 먼저 정리해야 합니다. 칼선(목형) 설계가 필요한 단상자 제작은 샘플 확인 후 양산에 들어가는 것이 안전합니다. 하오커뮤니케이션은 소량 디지털 패키지부터 대량 옵셋 양산까지 재질 샘플 기반으로 제안해드립니다." } },
    global: { label: "다국어디자인", eng: "GLOBAL EDITION", c: "다국어디자인",
      desc: "영어 · 중국어 · 일본어 등 수출 시장의 언어까지 한 번에 담아냅니다.",
      head: "언어가 바뀌어도\n톤은 흔들리지 않게",
      seoTitle: "다국어 카탈로그·영문 브로슈어 제작 | 수출 디자인 | 하오커뮤니케이션",
      seoDesc: "영문·중문·일문 다국어 카탈로그·브로슈어 제작. 원본 톤을 유지한 다국어 편집과 수출바우처 연계 제작까지 하오커뮤니케이션이 지원합니다.",
      seo: { h: "다국어카탈로그 · 영문브로슈어제작",
        ...
        t2: "다국어 디자인 준비 방법",
        p2: "다국어 카탈로그 제작을 준비할 때는 원본 디자인 파일과 언어별 번역문을 함께 준비하면 진행이 빠릅니다. 번역문이 없는 경우 번역 협업도 가능하며, 언어가 늘어도 일관된 톤을 유지하도록 같은 팀이 전체 언어를 관리하는 것이 좋습니다. 하오커뮤니케이션은 영어 · 중국어 · 일본어 등 다국어 편집을 원본 제작과 함께 원스톱으로 진행합니다." } }
  };

  /* 서비스 카테고리별 FAQ 기본값 (service.html 아코디언 + FAQPage 스키마) */
  var DEFAULT_FAQ = {
    catalog: [
      { q: "카탈로그 제작은 보통 얼마나 걸리나요?",
        a: "페이지 수, 원고 준비 상태, 촬영 여부에 따라 달라지지만, 하오커뮤니케이션은 기획, 디자인, 수정, 인쇄 검수, 납품까지 순서대로 진행하며 일반적으로 2~4주가량 소요됩니다." },
      { q: "브로슈어와 카탈로그의 차이는 무엇인가요?",
        a: "카탈로그는 제품 정보와 스펙을 체계적으로 보여주는 인쇄물이고, 브로슈어는 회사소개, 브랜드 소개, 서비스 설명처럼 메시지 전달에 적합한 홍보물입니다. 하오커뮤니케이션은 두 가지 모두 기획부터 편집디자인, 인쇄까지 진행합니다." },
      { q: "디자인만 맡기고 인쇄는 따로 진행할 수 있나요?",
        a: "가능합니다. 다만 하오커뮤니케이션은 카탈로그 디자인부터 인쇄, 후가공, 납품까지 원스톱 진행도 가능하며, 이 경우 색 보정과 인쇄 품질까지 한 팀이 관리합니다." },
      { q: "카탈로그 제작 비용은 어떻게 산정되나요?",
        a: "페이지 수, 인쇄 수량, 후가공(코팅·박·형압), 제품 촬영 포함 여부에 따라 산정됩니다. 사양을 알려주시면 무료로 견적을 안내드립니다." },
      { q: "회사소개서나 제품 카탈로그에 들어갈 사진 촬영도 가능한가요?",
        a: "네. 자체 촬영 서비스로 제품 컷과 연출 컷을 촬영해 바로 편집디자인에 반영합니다. 촬영과 디자인을 따로 맡길 때 생기는 톤 차이가 없습니다." },
    ],
    leaflet: [
      { q: "리플렛 제작 기간은 얼마나 걸리나요?",
        a: "구성과 수량에 따라 다르지만 리플렛 디자인부터 인쇄까지 보통 1~2주가량 소요됩니다. 행사 일정이 정해져 있다면 상담 시 알려주세요." },
      { q: "팜플렛과 리플렛의 차이는 무엇인가요?",
        a: "보통 여러 장을 제본한 소책자를 팜플렛, 한 장을 접어 만든 인쇄물을 리플렛이라 부릅니다. 하오커뮤니케이션은 두 형태 모두 기획부터 디자인, 인쇄까지 원스톱으로 제작합니다." },
      { q: "리플렛 접지 방식은 어떻게 정하나요?",
        a: "배포 장소와 정보량에 따라 2단·3단·대문접지 중 알맞은 방식을 제안드립니다. 접지에 따라 읽는 순서가 달라지므로 구성 기획 단계에서 함께 결정합니다." },
      { q: "리플렛 소량 인쇄도 가능한가요?",
        a: "네. 소량은 디지털 인쇄로, 대량은 옵셋 인쇄로 진행해 수량과 목적에 맞는 방식을 제안드립니다." },
      { q: "원고 없이 리플렛 디자인을 맡길 수 있나요?",
        a: "가능합니다. 전달할 핵심 메시지와 자료를 주시면 정보의 순서와 구성 기획부터 함께 진행합니다." },
    ],
    poster: [
      { q: "포스터 제작 사이즈는 어떻게 정하나요?",
        a: "부착 장소와 보는 거리를 고려해 A3부터 A0까지 제안드립니다. 멀리서 봐야 하는 장소일수록 큰 사이즈와 굵은 글자 위계가 필요합니다." },
      { q: "전단지 인쇄는 어떤 방식으로 진행되나요?",
        a: "배포 수량에 따라 소량은 디지털 인쇄, 대량은 옵셋 인쇄로 진행해 비용을 효율적으로 맞춥니다." },
      { q: "행사 포스터를 급하게 제작할 수도 있나요?",
        a: "포스터·전단지는 비교적 짧은 일정으로 제작 가능한 품목입니다. 일정을 먼저 알려주시면 가능한 범위를 안내드립니다." },
      { q: "포스터 디자인 시안 수정은 가능한가요?",
        a: "시안 확정 전까지 협의를 통해 수정을 진행합니다. 부착 환경에서 잘 읽히는지까지 검토해 완성합니다." },
      { q: "전단지 디자인부터 인쇄·납품까지 한 번에 되나요?",
        a: "네. 카피 위계 설계부터 디자인, 인쇄, 납품까지 원스톱으로 진행합니다." },
    ],
    ci: [
      { q: "로고 제작은 어떤 과정으로 진행되나요?",
        a: "문의 접수, 상담·견적, 기획·디자인, 수정·검수, 최종 파일 전달 순으로 진행됩니다. 브랜드명과 업종, 사용 목적을 알려주시면 방향 정리부터 시작합니다." },
      { q: "CI 디자인과 BI 디자인의 차이는 무엇인가요?",
        a: "CI는 기업 전체의 아이덴티티를, BI는 개별 브랜드나 제품의 아이덴티티를 다룹니다. 하오커뮤니케이션은 회사 로고부터 브랜드 로고, 응용 시스템까지 함께 설계합니다." },
      { q: "로고 디자인 완성 후 어떤 파일을 받게 되나요?",
        a: "AI 원본과 인쇄·온라인 겸용 파일을 함께 드립니다. 명함 제작, 홍보물 제작에 바로 활용할 수 있도록 정리해 전달합니다." },
      { q: "로고와 명함 디자인을 함께 제작할 수 있나요?",
        a: "네. 로고와 함께 명함, 서식 등 기본 응용 시스템까지 일관된 톤으로 확장해 드립니다." },
      { q: "로고 제작 전에 무엇을 준비하면 좋은가요?",
        a: "회사 소개와 지향하는 방향, 선호하는 레퍼런스를 정리해 주시면 시안의 정확도가 높아집니다. 정리가 어려우시면 상담에서 함께 잡아드립니다." },
    ],
    package: [
      { q: "패키지 디자인 의뢰 전에 무엇을 준비해야 하나요?",
        a: "제품 실물 또는 정확한 치수, 그리고 식품·화장품 등 품목별 표시사항 문구를 정리해 주시면 진행이 빠릅니다." },
      { q: "단상자 제작 시 칼선(목형) 설계도 해주나요?",
        a: "네. 패키지 구조 설계부터 진행하며, 칼선이 필요한 단상자는 샘플 확인 후 양산에 들어가 안전합니다." },
      { q: "패키지 소량 제작도 가능한가요?",
        a: "네. 소량 디지털 패키지부터 대량 옵셋 양산까지 수량에 맞는 방식을 제안드립니다." },
      { q: "라벨 디자인이나 스티커 제작만 따로 의뢰해도 되나요?",
        a: "가능합니다. 라벨, 스티커, 쇼핑백 등 필요한 품목만 따로 제작할 수 있습니다." },
      { q: "패키지 재질과 후가공은 어떻게 결정하나요?",
        a: "같은 패키지 디자인도 재질과 후가공에 따라 인상이 크게 달라지므로, 재질 샘플을 기반으로 제품에 맞는 조합을 제안드립니다." },
    ],
    global: [
      { q: "다국어 카탈로그 제작은 어떤 언어까지 가능한가요?",
        a: "영어·중국어·일본어·프랑스어 등 5개국 다국어 인쇄물 제작에 대응합니다. 필요한 언어를 알려주시면 진행 방식을 안내드립니다." },
      { q: "번역문 없이 영문 카탈로그 제작을 맡길 수 있나요?",
        a: "네. 번역문이 준비되어 있으면 진행이 가장 빠르지만, 없는 경우 번역 협업도 가능합니다." },
      { q: "다국어 디자인은 단순 번역 교체와 무엇이 다른가요?",
        a: "언어별 글줄 길이와 타이포그래피 호흡에 맞춰 재조판하는 작업입니다. 원본의 레이아웃과 브랜드 톤을 유지하는 것이 핵심입니다." },
      { q: "국문 카탈로그와 영문 브로슈어를 함께 제작할 수 있나요?",
        a: "네. 원본 제작과 다국어 편집을 같은 팀이 원스톱으로 진행해, 언어가 늘어도 일관된 톤을 유지합니다." },
      { q: "수출바우처로 다국어 인쇄물을 제작할 수 있나요?",
        a: "네. 전시회·해외 영업용 다국어 홍보물은 수출바우처 등 정부지원사업과 연계해 제작 부담을 줄일 수 있습니다." },
    ],
  };
  Object.keys(DEFAULT_FAQ).forEach(function (k) { if (DEFAULT_SERVICE[k]) DEFAULT_SERVICE[k].faq = DEFAULT_FAQ[k]; });

  /* 검색 변형 키워드: alt=소개 글 하단 노출 문단, kw=meta keywords (카다로그·브로셔 등 다른 표기 흡수) */
  var DEFAULT_SEOALT = {
    catalog: { alt: "카탈로그 제작 · 카다로그 · 카달로그 · 브로슈어 제작 · 브로셔 · 회사소개서 디자인 · 카탈로그 제작 업체 · 인쇄물 디자인 · 편집디자인",
      kw: "카탈로그 제작, 카다로그, 카달로그, 브로슈어 제작, 브로셔, 카탈로그 디자인, 카탈로그 제작 업체, 회사소개서 디자인, 인쇄물 디자인 업체, 홍보물 제작 업체, 편집디자인" },
    leaflet: { alt: "리플렛 제작 · 리플릿 · 팜플렛 제작 · 팜플릿 · 팸플릿 · 3단 리플렛 · 접지 인쇄 · 홍보물 제작",
      kw: "리플렛 제작, 리플릿, 팜플렛 제작, 팜플릿, 팸플릿, 리플렛 디자인, 3단 리플렛, 접지 인쇄, 홍보물 제작 업체, 인쇄물 디자인" },
    poster: { alt: "포스터 제작 · 포스터 디자인 · 포스터 인쇄 · 전단지 제작 · 전단 인쇄 · 전단지 디자인 · 행사 포스터",
      kw: "포스터 제작, 포스터 디자인, 포스터 인쇄, 전단지 제작, 전단 인쇄, 전단지 디자인, 행사 포스터, 홍보물 제작 업체" },
    ci: { alt: "로고 제작 · 로고 디자인 · CI 디자인 · BI 디자인 · 회사 로고 · 심볼 로고 · 명함 디자인",
      kw: "로고 제작, 로고 디자인 업체, 로고제작업체, CI 디자인, BI 디자인, 회사 로고 제작, 심볼 로고, 명함 디자인" },
    package: { alt: "패키지 디자인 · 패키지 제작 · 박스 디자인 · 단상자 제작 · 포장지 디자인 · 라벨 디자인 · 스티커 제작 · 쇼핑백",
      kw: "패키지 디자인, 패키지 제작 업체, 단상자 제작, 박스 디자인, 포장지 디자인, 라벨 디자인, 스티커 제작, 쇼핑백 제작" },
    global: { alt: "다국어 카탈로그 · 영문 카탈로그 · 영문 브로셔 · 영문 카다로그 · 중문 카탈로그 · 일문 카탈로그 · 수출 인쇄물",
  ...
  /* 서비스: 관리자 확정값으로 기본값 덮어쓰기 (process 포함 — 카테고리별 진행과정) */
  var BAKED_SERVICE = {"ci":{"c":"CI·로고디자인","eng":"CI & LOGO","seo":{"h":"로고제작 · CI디자인","p1":"로고 디자인과 CI 디자인은 브랜드의 첫인상을 결정하는 가장 중요한 자산입니다. 로고 제작은 단순히 예쁜 심볼을 만드는 일이 아니라, 회사의 방향과 가치를 한 번에 전달하는 시각 언어를 설계하는 일입니다. 명함, 서식류, 홍보물, 간판까지 일관되게 적용되는 CI는 기업의 신뢰도를 높이고 브랜드 인지도를 만들어 갑니다.","p2":"로고 제작을 의뢰할 때는 회사 소개와 지향하는 방향, 선호하는 레퍼런스를 정리해 전달하면 시안의 정확도가 높아집니다. 완성된 로고는 AI 원본과 인쇄 · 온라인 겸용 파일로 제공받아야 명함 제작, 홍보물 제작에 바로 활용할 수 있습니다. 하오커뮤니케이션은 로고 디자인부터 기본 응용 시스템, 사용 가이드까지 함께 정리해드립니다.","t1":"로고 및 CI에 대하여","t2":"로고 및 CI 준비 방법"},"desc":"기업의 정체성과 방향을 담아\n다양한 매체에 활용 가능한 로고를 제작합니다.","head":"브랜드를 기억하게 하는\n가장 작은 디자인","label":"CI · 로고디자인","process":[{"h":"문의 접수","p":"브랜드명, 업종, 사용 목적 등\n필요한 내용을 확인합니다."},{"h":"상담 · 견적","p":"로고 제작 범위와 방향을 정리하고\n견적과 일정을 안내드립니다."},{"h":"기획 · 디자인","p":"브랜드 컨셉을 바탕으로\n로고 시안을 제작합니다."},{"h":"수정 · 검수","p":"전달주신 의견을 반영해\n로고의 완성도를 높입니다."},{"h":"최종 파일 전달","p":"확정된 로고를 정리해\n활용 가능한 파일로 전달드립니다."}],"seoDesc":"회사 로고 제작과 CI 디자인. 명함·서식 등 기본 응용 시스템과 인쇄·온라인 겸용 파일까지 제공하는 하오커뮤니케이션 브랜딩 서비스.","seoTitle":"로고 제작·CI 디자인 | 브랜드 로고·명함 디자인 | 하오커뮤니케이션"},"global":{"c":"다국어디자인","eng":"GLOBAL EDITION","seo":{"h":"다국어카탈로그 · 영문브로슈어제작","p1":"수출 기업에게 영문 카탈로그 제작, 중문 브로슈어 제작은 해외 바이어를 만나는 첫인상입니다. 다국어 디자인은 단순 번역이 아니라 언어별 글줄 길이와 타이포그래피 호흡에 맞춘 재조판 작업으로, 원본의 레이아웃과 브랜드 톤을 유지하는 것이 핵심입니다. 전시회 · 해외 영업용 다국어 홍보물은 수출바우처 등 정부지원사업과 연계해 제작 부담을 줄일 수도 있습니다.","p2":"다국어 카탈로그 제작을 준비할 때는 원본 디자인 파일과 언어별 번역문을 함께 준비하면 진행이 빠릅니다. 번역문이 없는 경우 번역 협업도 가능하며, 언어가 늘어도 일관된 톤을 유지하도록 같은 팀이 전체 언어를 관리하는 것이 좋습니다. 하오커뮤니케이션은 영어 · 중국어 · 일본어 등 다국어 편집을 원본 제작과 함께 원스톱으로 진행합니다.","t1":"다국어 디자인에 대하여","t2":"다국어 디자인 준비 방법"},"desc":"번역된 내용을 디자인에 자연스럽게 반영해\n국내외에서 일관된 브랜드 이미지를 유지합니다.","head":"언어가 바뀌어도\n메시지는 흔들리지 않게","label":"다국어디자인","process":[{"h":"문의 접수","p":"제작물 종류, 언어, 일정 등\n필요한 내용을 확인합니다."},{"h":"상담 · 견적","p":"번역 범위와 디자인 작업 내용을\n정리하고 견적과 일정을 안내드립니다."},{"h":"번역 · 자료 정리","p":"원문 내용을 확인한 뒤\n사용 언어에 맞게 번역을 진행합니다."},{"h":"다국어 디자인","p":"번역된 내용을 디자인에 반영해\n언어별 가독성과 구성을 조정합니다."},{"h":"검수 · 파일 전달","p":"최종 내용을 검수한 뒤\n사용 가능한 파일로 전달드립니다."}],"seoDesc":"영문·중문·일문 다국어 카탈로그·브로슈어 제작. 원본 톤을 유지한 다국어 편집과 수출바우처 연계 제작까지 하오커뮤니케이션이 지원합니다.","seoTitle":"다국어 카탈로그·영문 브로슈어 제작 | 수출 디자인 | 하오커뮤니케이션"},"poster":{"c":"포스터·전단지","eng":"POSTER & FLYER","seo":{"h":"포스터제작 · 전단지제작","p1":"포스터 제작과 전단지 제작은 가장 직관적인 오프라인 홍보 수단입니다. 행사 포스터, 공연 포스터, 모집 공고 포스터는 멀리서도 읽히는 타이포그래피와 임팩트 있는 비주얼이 핵심이며, 판촉용 전단지는 짧은 시간에 혜택과 정보를 전달하는 구성이 중요합니다. 잘 만든 포스터 디자인 한 장은 지나가는 사람의 발걸음을 멈추게 합니다.","p2":"포스터 디자인을 준비할 때는 부착 장소와 보는 거리를 먼저 고려해 사이즈(A3~A0)와 글자 크기를 정해야 합니다. 전단지 제작은 배포 수량과 방식에 따라 용지와 인쇄 방식(디지털 · 옵셋)을 선택하면 비용을 효율적으로 줄일 수 있습니다. 하오커뮤니케이션은 목적에 맞는 카피 위계 설계부터 인쇄 · 납품까지 한 번에 진행합니다.","t1":"포스터 및 전단지에 대하여","t2":"포스터 및 전단지 준비 방법"},"desc":"홍보 목적과 노출 환경에 맞춰\n주목도 높은 포스터와 전단지를 제작합니다.","head":"지나가는 시선도\n멈추게 만드는 디자인","label":"포스터 · 전단지","process":[{"h":"문의 접수","p":"제작물 종류와 일정,\n필요한 내용을 확인합니다."},{"h":"상담 · 견적","p":"프로젝트 범위와 사양을 정리하고\n견적과 일정을 안내드립니다."},{"h":"기획 · 디자인","p":"자료를 검토한 뒤 브랜드에 맞는\n방향으로 시안을 제작합니다."},{"h":"수정 · 검수","p":"전달주신 의견을 반영하고\n최종 제작 전 결과물을 검수합니다."},{"h":"인쇄 · 납품","p":"인쇄와 후가공을 진행한 뒤\n완성된 결과물을 납품합니다."}],"seoDesc":"행사·공연·모집 포스터, 판촉 전단지 제작. 멀리서도 읽히는 포스터 디자인부터 인쇄·납품까지 하오커뮤니케이션이 한 번에 진행합니다.","seoTitle":"포스터 제작·전단지 디자인 | 행사·홍보 포스터 인쇄 | 하오커뮤니케이션"},"catalog":{"c":"카탈로그·브로슈어","eng":"CATALOG & BROCHURE","seo":{"h":"카탈로그제작 · 브로슈어제작","p1":"기업의 이미지를 효과적으로 전달하는 가장 기본적인 홍보물이 바로 카탈로그와 브로슈어입니다. 카탈로그 제작은 제품과 서비스를 체계적으로 보여줄 수 있으며, 브로슈어 제작은 브랜드 스토리를 감각적으로 담아내는 데 적합합니다. 기획 단계에서부터 디자인, 인쇄, 후가공까지 전문적인 과정을 거쳐 완성되는 카탈로그 디자인과 브로슈어 디자인은 기업의 신뢰도를 높이고 차별화된 경쟁력을 제공합니다. 전시회, 영업 현장, 온라인 홍보까지 활용도가 높아 많은 기업이 카탈로그 · 브로슈어 제작을 통해 마케팅 성과를 경험하고 있습니다.","p2":"카탈로그 제작이나 브로슈어 디자인을 준비할 때는 먼저 목적과 타깃을 명확히 설정하고, 그에 맞는 구성과 페이지 수를 기획하는 것이 중요합니다. 디자인 단계에서는 브랜드 아이덴티티에 맞는 레이아웃과 색상을 적용하고, 인쇄 단계에서는 종이 재질과 후가공(코팅, 박, 제본 등)을 신중히 선택해야 완성도가 높아집니다. 하오커뮤니케이션은 회사소개서, 제품 카탈로그, 기업 브로슈어까지 기획부터 납품까지 원스톱으로 진행합니다.","t1":"카탈로그 및 브로슈어에 대하여","t2":"카탈로그 및 브로슈어 준비 방법"},"desc":"제품의 특징과 브랜드의 강점을\n명확하게 전달하는 카탈로그 · 브로슈어를 제작합니다.","head":"좋은 카탈로그는\n브랜드를 대신해 말합니다","label":"카탈로그 · 브로슈어","process":[{"h":"문의 접수","p":"제작물 종류와 일정,\n필요한 내용을 확인합니다."},{"h":"상담 · 견적","p":"프로젝트 범위와 사양을 정리하고\n견적과 일정을 안내드립니다."},{"h":"기획 · 디자인","p":"자료를 검토한 뒤 브랜드에 맞는\n방향으로 시안을 제작합니다."},{"h":"수정 · 검수","p":"전달주신 의견을 반영하고\n최종 제작 전 결과물을 검수합니다."},{"h":"인쇄 · 납품","p":"인쇄와 후가공을 진행한 뒤\n완성된 결과물을 납품합니다."}],"seoDesc":"회사소개서·제품 카탈로그·브로슈어 편집디자인부터 인쇄·후가공까지 원스톱. 기획·디자인·제작을 한 팀이 책임지는 하오커뮤니케이션 카탈로그 제작 서비스.","seoTitle":"카탈로그 제작·브로슈어 디자인 | 회사소개서 편집디자인 | 하오커뮤니케이션"},"leaflet":{"c":"리플렛","eng":"PAMPHLET & LEAFLET","seo":{"h":"팜플렛제작 · 리플렛제작","p1":"행사 안내, 제품 소개, 매장 홍보에 가장 널리 쓰이는 인쇄물이 팜플렛과 리플렛입니다. 리플렛 제작은 2단 · 3단 접지로 작은 지면에 핵심 정보를 효율적으로 담을 수 있고, 팜플렛 디자인은 배포와 휴대가 쉬워 전시회 · 박람회 · 오프라인 마케팅에서 높은 효과를 냅니다. 접지 방식과 읽는 동선까지 계산된 리플렛 디자인은 같은 내용도 더 잘 전달되게 만듭니다.","p2":"팜플렛 제작을 준비할 때는 배포 장소와 대상, 전달할 핵심 메시지를 먼저 정해야 합니다. 접지 방식(2단 · 3단 · 대문접지)에 따라 정보의 순서가 달라지므로 구성 기획이 중요하고, 용지 평량과 코팅 여부에 따라 손에 닿는 인상이 달라집니다. 하오커뮤니케이션은 소량 디지털 인쇄부터 대량 옵셋 인쇄까지 목적과 수량에 맞는 팜플렛 · 리플렛 제작을 제안해드립니다.","t1":"팜플렛 및 리플렛에 대하여","t2":"팜플렛 및 리플렛 준비 방법"},"desc":"제품 · 서비스 · 행사 정보를\n보기 쉽게 담아내는\n리플렛 · 팜플렛을 제작합니다.","head":"가볍게 펼쳐도\n브랜드는 선명하게","label":"팜플렛 · 리플렛","process":[{"h":"문의 접수","p":"제작물 종류와 일정,\n필요한 내용을 확인합니다."},{"h":"상담 · 견적","p":"프로젝트 범위와 사양을 정리하고\n견적과 일정을 안내드립니다."},{"h":"기획 · 디자인","p":"자료를 검토한 뒤 브랜드에 맞는\n방향으로 시안을 제작합니다."},{"h":"수정 · 검수","p":"전달주신 의견을 반영하고\n최종 제작 전 결과물을 검수합니다."},{"h":"인쇄 · 납품","p":"인쇄와 후가공을 진행한 뒤\n완성된 결과물을 납품합니다."}],"seoDesc":"행사·매장·제품 안내 팜플렛·리플렛 제작. 2단·3단·대문접지 등 목적에 맞는 리플렛 디자인과 인쇄를 하오커뮤니케이션이 원스톱으로 제작합니다.","seoTitle":"팜플렛·리플렛 제작 | 2단·3단 접지 리플렛 디자인 | 하오커뮤니케이션"},"package":{"c":"패키지·라벨","eng":"PACKAGE & LABEL","seo":{"h":"패키지디자인 · 라벨제작","p1":"패키지 디자인은 매대에서 제품이 스스로 말을 걸게 만드는 가장 강력한 마케팅 도구입니다. 단상자 제작, 라벨 디자인, 스티커 제작, 쇼핑백 제작까지 — 제품을 감싸는 모든 요소가 브랜드 경험의 일부가 됩니다. 재질과 후가공에 따라 같은 디자인도 전혀 다른 인상을 주기 때문에 구조 설계부터 신중하게 접근해야 합니다.","p2":"패키지 제작을 준비할 때는 제품 실물 또는 정확한 치수와 함께 식품 · 화장품 등 품목별 표시사항 문구를 먼저 정리해야 합니다. 칼선(목형) 설계가 필요한 단상자 제작은 샘플 확인 후 양산에 들어가는 것이 안전합니다. 하오커뮤니케이션은 소량 디지털 패키지부터 대량 옵셋 양산까지 재질 샘플 기반으로 제안해드립니다.","t1":"패키지 및 라벨에 대하여","t2":"패키지 및 라벨 준비 방법"},"desc":"제품 콘셉트와 판매 채널에 맞춰\n브랜드에 어울리는 패키지를 만듭니다.","head":"제품을 더 돋보이게 하는\n패키지 디자인","label":"패키지 · 라벨","process":[{"h":"문의 접수","p":"제작물 종류와 일정,\n필요한 내용을 확인합니다."},{"h":"상담 · 견적","p":"프로젝트 범위와 사양을 정리하고\n견적과 일정을 안내드립니다."},{"h":"기획 · 디자인","p":"자료를 검토한 뒤 브랜드에 맞는\n방향으로 시안을 제작합니다."},{"h":"수정 · 검수","p":"전달주신 의견을 반영하고\n최종 제작 전 결과물을 검수합니다."},{"h":"인쇄 · 납품","p":"인쇄와 후가공을 진행한 뒤\n완성된 결과물을 납품합니다."}],"seoDesc":"단상자·라벨·스티커·쇼핑백 등 패키지 디자인 제작. 구조 설계부터 재질·후가공, 소량 제작과 양산까지 하오커뮤니케이션이 함께합니다.","seoTitle":"패키지 디자인·라벨 제작 | 단상자·스티커 디자인 | 하오커뮤니케이션"}};
  Object.keys(BAKED_SERVICE).forEach(function (k) {
    if (!DEFAULT_SERVICE[k]) return;
    Object.keys(BAKED_SERVICE[k]).forEach(function (f) {
      if (f === "seo" && BAKED_SERVICE[k].seo) { Object.keys(BAKED_SERVICE[k].seo).forEach(function (s) { DEFAULT_SERVICE[k].seo[s] = BAKED_SERVICE[k].seo[s]; }); }
      else if (Array.isArray(BAKED_SERVICE[k][f])) { DEFAULT_SERVICE[k][f] = BAKED_SERVICE[k][f]; }
      else if (typeof BAKED_SERVICE[k][f] === "string") { DEFAULT_SERVICE[k][f] = BAKED_SERVICE[k][f]; }
    });
  });
