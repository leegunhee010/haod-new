...
(function () {
  ...
  var DEFAULT_SEOALT = {
    catalog: { alt: "카탈로그 · 카다로그 · 카달로그, 브로슈어 · 브로셔 — 부르는 이름은 달라도 결과물의 기준은 하나입니다. 하오디자인은 회사소개서부터 제품 카탈로그, 기업 브로슈어까지 편집디자인과 인쇄를 한 팀이 책임지는 인쇄물 디자인 업체입니다.",
      kw: "카탈로그 제작, 카다로그, 카달로그, 브로슈어 제작, 브로셔, 카탈로그 디자인, 카탈로그 제작 업체, 회사소개서 디자인, 인쇄물 디자인 업체, 홍보물 제작 업체, 편집디자인" },
    leaflet: { alt: "리플렛 · 리플릿, 팜플렛 · 팜플릿 · 팸플릿 — 표기가 어떻든 펼치는 순간의 경험은 같아야 합니다. 하오디자인은 2단 · 3단 접지 홍보물을 기획부터 인쇄까지 함께하는 리플렛 제작 업체입니다.",
      kw: "리플렛 제작, 리플릿, 팜플렛 제작, 팜플릿, 팸플릿, 리플렛 디자인, 3단 리플렛, 접지 인쇄, 홍보물 제작 업체, 인쇄물 디자인" },
    poster: { alt: "포스터 디자인 · 포스터 인쇄, 전단지 · 전단 제작 — 이름보다 중요한 건 거리에서 읽히는 3초입니다. 하오디자인은 행사 · 홍보 인쇄물을 디자인부터 인쇄 · 납품까지 진행합니다.",
      kw: "포스터 제작, 포스터 디자인, 포스터 인쇄, 전단지 제작, 전단 인쇄, 전단지 디자인, 행사 포스터, 홍보물 제작 업체" },
    ci: { alt: "로고 제작 · 로고 디자인 · CI · BI — 어떤 이름으로 시작하든 도착점은 브랜드다운 얼굴입니다. 하오디자인은 회사 로고부터 명함 · 서식 응용 시스템까지 만드는 로고 디자인 업체입니다.",
      kw: "로고 제작, 로고 디자인 업체, 로고제작업체, CI 디자인, BI 디자인, 회사 로고 제작, 심볼 로고, 명함 디자인" },
    package: { alt: "패키지 디자인 · 박스 디자인 · 단상자 · 라벨 · 스티커 — 제품을 감싸는 모든 것이 우리 일입니다. 하오디자인은 구조 설계부터 양산까지 함께하는 패키지 제작 업체입니다.",
      kw: "패키지 디자인, 패키지 제작 업체, 단상자 제작, 박스 디자인, 포장지 디자인, 라벨 디자인, 스티커 제작, 쇼핑백 제작" },
    global: { alt: "영문 카탈로그 · 영문 브로셔 · 중문 · 일문 카탈로그 — 언어가 몇 개든 브랜드의 톤은 하나입니다. 하오디자인은 수출용 인쇄물의 다국어 편집을 원스톱으로 진행하는 디자인 업체입니다.",
