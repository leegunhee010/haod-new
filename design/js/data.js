  ...
  var DEFAULT_FAQ = {
    catalog: [
      { q: "카탈로그 제작은 보통 얼마나 걸리나요?",
        a: "페이지 수, 원고 준비 상태, 촬영 여부에 따라 달라지지만, 하오디자인은 기획, 디자인, 수정, 인쇄 검수, 납품까지 순서대로 진행하며 일반적으로 2~4주가량 소요됩니다." },
      { q: "브로슈어와 카탈로그의 차이는 무엇인가요?",
        a: "카탈로그는 제품 정보와 스펙을 체계적으로 보여주는 인쇄물이고, 브로슈어는 회사소개, 브랜드 소개, 서비스 설명처럼 메시지 전달에 적합한 홍보물입니다. 하오디자인은 두 가지 모두 기획부터 편집디자인, 인쇄까지 진행합니다." },
      { q: "디자인만 맡기고 인쇄는 따로 진행할 수 있나요?",
        a: "가능합니다. 다만 하오디자인은 카탈로그 디자인부터 인쇄, 후가공, 납품까지 원스톱 진행도 가능하며, 이 경우 색 보정과 인쇄 품질까지 한 팀이 관리합니다." },
    ...
    leaflet: [
      ...
      { q: "팜플렛과 리플렛의 차이는 무엇인가요?",
        a: "보통 여러 장을 제본한 소책자를 팜플렛, 한 장을 접어 만든 인쇄물을 리플렛이라 부릅니다. 하오디자인은 두 형태 모두 기획부터 디자인, 인쇄까지 원스톱으로 제작합니다." },
    ...
    ci: [
      ...
      { q: "CI 디자인과 BI 디자인의 차이는 무엇인가요?",
        a: "CI는 기업 전체의 아이덴티티를, BI는 개별 브랜드나 제품의 아이덴티티를 다룹니다. 하오디자인은 회사 로고부터 브랜드 로고, 응용 시스템까지 함께 설계합니다." },
