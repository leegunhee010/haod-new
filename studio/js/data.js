...
(function () {
  ...
  var DEFAULT_COPY = [
    ...
    { key: "pst1_h", page: "index", sel: ".tstep:nth-child(1) h3", tag: "b", label: "진행과정① 제목", value: "문의 · 상담" },
    { key: "pst1_p", page: "index", sel: ".tstep:nth-child(1) p", tag: "b", label: "진행과정① 설명", value: "촬영 종류·컷 수·일정을 알려주시면 빠르게 상담해 드립니다." },
    { key: "pst2_h", page: "index", sel: ".tstep:nth-child(2) h3", tag: "b", label: "진행과정② 제목", value: "견적 · 일정" },
    { key: "pst2_p", page: "index", sel: ".tstep:nth-child(2) p", tag: "b", label: "진행과정② 설명", value: "요구사항에 맞춰 합리적인 견적과 촬영 일정을 확정합니다." },
    { key: "pst3_h", page: "index", sel: ".tstep:nth-child(3) h3", tag: "b", label: "진행과정③ 제목", value: "콘티 · 연출" },
    { key: "pst3_p", page: "index", sel: ".tstep:nth-child(3) p", tag: "b", label: "진행과정③ 설명", value: "레퍼런스로 무드와 컷 리스트를 설계해 방향을 맞춥니다." },
    { key: "pst4_h", page: "index", sel: ".tstep:nth-child(4) h3", tag: "b", label: "진행과정④ 제목", value: "촬영 · 컨펌" },
    { key: "pst4_p", page: "index", sel: ".tstep:nth-child(4) p", tag: "b", label: "진행과정④ 설명", value: "스튜디오·현장에서 컷별 컨펌을 받으며 촬영합니다." },
    { key: "pst5_h", page: "index", sel: ".tstep:nth-child(5) h3", tag: "b", label: "진행과정⑤ 제목", value: "보정 · 납품" },
    { key: "pst5_p", page: "index", sel: ".tstep:nth-child(5) p", tag: "b", label: "진행과정⑤ 설명", value: "누끼·색보정·리터칭 후 규격별로 정리해 납품합니다." },
  ...
  window.HAO = {
    ...
    getCred: function () { return loadObj("hs_admin_cred", { id: "admin", pw: "studio1234" }); },
