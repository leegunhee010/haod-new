...
(function () {
  ...
  var DEFAULT_COPY = [
    ...
    { key: "mk_sv_h", page: "index", sel: "#services .on__h", tag: "b", label: "서비스 — 제목", value: "작은 브랜드일수록,\n**‘어떻게 보이느냐’가 전부입니다**" },
    { key: "mk_sv_sub", page: "index", sel: "#services .on__sub", tag: "b", label: "서비스 — 부제", value: "하오디자인 마케팅센터는 중소기업의 이야기를 디자인으로 풀어,\n사람의 마음을 움직이는 마케팅을 만듭니다." },
    { key: "mk_sv_c1_cat", page: "index", sel: "#services .svq:nth-of-type(1) .svq__t small", tag: "b", label: "서비스 카드1 — 분류", value: "브랜드 콘텐츠" },
    { key: "mk_sv_c1_s1", page: "index", sel: "#services .svq:nth-of-type(1) .svq__sub:nth-of-type(1)", tag: "b", label: "서비스 카드1 — 문구1", value: "로고·키비주얼부터 SNS 콘텐츠·홍보영상까지 **브랜드 톤을 통일**해 제작합니다." },
    { key: "mk_sv_c1_s2", page: "index", sel: "#services .svq:nth-of-type(1) .svq__sub:nth-of-type(2)", tag: "b", label: "서비스 카드1 — 문구2", value: "채널별 운영 계획을 세우고, **꾸준히 쌓이는 콘텐츠**로 브랜드의 얼굴을 만듭니다." },
    { key: "mk_sv_c1_s3", page: "index", sel: "#services .svq:nth-of-type(1) .svq__sub:nth-of-type(3)", tag: "b", label: "서비스 카드1 — 문구3", value: "고객과 감성적으로 연결되는 스토리로 **기억에 남는 브랜드**를 만듭니다." },
    { key: "mk_sv_c2_cat", page: "index", sel: "#services .svq:nth-of-type(2) .svq__t small", tag: "b", label: "서비스 카드2 — 분류", value: "커머스 디자인" },
    { key: "mk_sv_c2_s1", page: "index", sel: "#services .svq:nth-of-type(2) .svq__sub:nth-of-type(1)", tag: "b", label: "서비스 카드2 — 문구1", value: "스마트스토어·자사몰 **상세페이지**를 구매 흐름에 맞춰 설계합니다." },
    { key: "mk_sv_c2_s2", page: "index", sel: "#services .svq:nth-of-type(2) .svq__sub:nth-of-type(2)", tag: "b", label: "서비스 카드2 — 문구2", value: "패키지·배너·이벤트 페이지까지 **판매에 필요한 디자인을 일괄** 제작합니다." },
    { key: "mk_sv_c2_s3", page: "index", sel: "#services .svq:nth-of-type(2) .svq__sub:nth-of-type(3)", tag: "b", label: "서비스 카드2 — 문구3", value: "보는 순간부터 사는 순간까지 경험을 다듬어 **매출로 이어지게** 합니다." },
    { key: "mk_sv_c3_cat", page: "index", sel: "#services .svq:nth-of-type(3) .svq__t small", tag: "b", label: "서비스 카드3 — 분류", value: "전시 · 박람회 부스" },
    { key: "mk_sv_c3_s1", page: "index", sel: "#services .svq:nth-of-type(3) .svq__sub:nth-of-type(1)", tag: "b", label: "서비스 카드3 — 문구1", value: "**부스 디자인**부터 제작·시공 일정까지 역산해 준비합니다." },
    { key: "mk_sv_c3_s2", page: "index", sel: "#services .svq:nth-of-type(3) .svq__sub:nth-of-type(2)", tag: "b", label: "서비스 카드3 — 문구2", value: "카탈로그·배너·리플릿 등 **오프라인 홍보물**을 한 톤으로 제작합니다." },
    { key: "mk_sv_c3_s3", page: "index", sel: "#services .svq:nth-of-type(3) .svq__sub:nth-of-type(3)", tag: "b", label: "서비스 카드3 — 문구3", value: "화면 밖 현장에서도 브랜드가 **기억에 남게** 만듭니다." },
