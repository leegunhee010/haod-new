...
(function () {
  ...
  var DEFAULT_COPY = [
    ...
    { key: "mk_ix_37", page: "index", sel: "#services > div > p:nth-of-type(1)", tag: "b", label: "서비스 · SERVICES", value: "SERVICES" },
    { key: "mk_ix_38", page: "index", sel: "#services > div > h2", tag: "b", label: "서비스 · 작은 브랜드일수록,‘어떻게 보이느냐’가 전부", value: "작은 브랜드일수록,\n**‘어떻게 보이느냐’가 전부입니다**" },
    { key: "mk_ix_39", page: "index", sel: "#services > div > p:nth-of-type(2)", tag: "b", label: "서비스 · 하오디자인 마케팅센터는 중소기업의 이야기를 ", value: "하오디자인 마케팅센터는 중소기업의 이야기를 디자인으로 풀어,\n사람의 마음을 움직이는 마케팅을 만듭니다." },
    { key: "mk_ix_40", page: "index", sel: "#services > div > div > div:nth-of-type(1) > div > span > small", tag: "b", label: "서비스 · SERVICE", value: "SERVICE" },
    { key: "mk_ix_41", page: "index", sel: "#services > div > div > div:nth-of-type(1) > h3 > small", tag: "b", label: "서비스 · BRAND CONTENT", value: "BRAND CONTENT" },
    { key: "mk_ix_42", page: "index", sel: "#services > div > div > div:nth-of-type(1) > p:nth-of-type(1)", tag: "b", label: "서비스 · 로고·키비주얼부터 SNS·상세 이미지·홍보영", value: "로고·키비주얼부터 SNS·상세 이미지·홍보영상까지, **브랜드의 결**을 담아 제작합니다." },
    { key: "mk_ix_43", page: "index", sel: "#services > div > div > div:nth-of-type(1) > p:nth-of-type(2)", tag: "b", label: "서비스 · 브랜드의 분위기를 담은 콘텐츠로 고객과 감성", value: "브랜드의 분위기를 담은 콘텐츠로 고객과 감성적으로 연결합니다." },
    { key: "mk_ix_44", page: "index", sel: "#services > div > div > div:nth-of-type(2) > div > span > small", tag: "b", label: "서비스 · SERVICE", value: "SERVICE" },
    { key: "mk_ix_45", page: "index", sel: "#services > div > div > div:nth-of-type(2) > h3 > small", tag: "b", label: "서비스 · COMMERCE DESIGN", value: "COMMERCE DESIGN" },
    { key: "mk_ix_46", page: "index", sel: "#services > div > div > div:nth-of-type(2) > p:nth-of-type(1)", tag: "b", label: "서비스 · 스마트스토어·자사몰 상세페이지부터 패키지·배", value: "스마트스토어·자사몰 상세페이지부터 패키지·배너까지 **일괄 제작**합니다." },
    { key: "mk_ix_47", page: "index", sel: "#services > div > div > div:nth-of-type(2) > p:nth-of-type(2)", tag: "b", label: "서비스 · 사는 순간까지의 경험을 디자인해 매출로 이어", value: "사는 순간까지의 경험을 디자인해 매출로 이어지게 합니다." },
    { key: "mk_ix_48", page: "index", sel: "#services > div > div > div:nth-of-type(3) > div > span > small", tag: "b", label: "서비스 · SERVICE", value: "SERVICE" },
    { key: "mk_ix_49", page: "index", sel: "#services > div > div > div:nth-of-type(3) > p:nth-of-type(1)", tag: "b", label: "서비스 · 전시회·박람회 부스 디자인과 카탈로그·배너 ", value: "전시회·박람회 **부스 디자인**과 카탈로그·배너 등 오프라인 홍보물을 만듭니다." },
    { key: "mk_ix_50", page: "index", sel: "#services > div > div > div:nth-of-type(3) > p:nth-of-type(2)", tag: "b", label: "서비스 · 화면 밖 현장에서도 브랜드가 기억에 남게 합", value: "화면 밖 현장에서도 브랜드가 기억에 남게 합니다." },
