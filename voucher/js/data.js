...
(function () {
  ...
  var DEFAULT_POSTS = [
    { id: 6, title: '2026 수출바우처 신청 일정 한눈에 정리', summary: '차수별 모집 일정과 우선순위, 준비 서류를 시기별로 정리했습니다.', date: '2026.06.18', img: 'assets/img/big_slide_02.jpg', isNew: true,
      body: ['수출바우처는 매년 여러 차수에 걸쳐 모집이 진행됩니다. 1차 모집은 보통 연초에 시작되며, 차수마다 배정 예산과 우선 선정 분야가 다릅니다.', '동일 공고 내 최대 2개 사업까지 신청할 수 있지만 우선순위가 높은 1개 사업만 선정되므로, 신청 전 우선순위를 명확히 정해두는 것이 중요합니다.', '신청서·사업계획·증빙 서류는 마감 직전에 몰리기 쉬우므로 최소 2주 전부터 준비하시길 권합니다. 하오커뮤니케이션은 신청 준비 단계부터 무료로 안내해 드립니다.'] },
    ...
    { id: 4, title: '바우처로 카탈로그·브로슈어 제작하는 법', summary: '메뉴판에서 디자인 서비스를 고르는 기준과 효과를 높이는 팁.', date: '2026.05.29', img: 'assets/img/big_slide_04.jpg', isNew: false,
      body: ['바우처 메뉴판에는 디자인·인쇄 서비스가 카테고리별로 등록되어 있습니다. 결과물의 용도(수출 상담회, 해외 바이어 제안 등)에 맞는 카테고리를 고르는 것이 첫 단계입니다.', '판형·페이지 수·후가공을 미리 정하면 부담금 대비 완성도를 높일 수 있습니다. 하오커뮤니케이션은 인쇄 감리까지 직접 챙겨 화면과 종이의 차이를 줄입니다.'] },
    ...
    { id: 2, title: '결과보고서 작성 체크리스트 7가지', summary: '평가를 통과하는 결과보고서의 필수 항목을 정리했습니다.', date: '2026.05.12', img: 'assets/img/main_07.png', isNew: false,
      body: ['결과보고는 사업 종료만큼 중요합니다. 평가 기준과 작성 요건을 정확히 이해해야 다음 참여에도 유리합니다.', '① 사업 목표 대비 성과 ② 정량 지표 ③ 산출물 증빙 ④ 예산 집행 내역 ⑤ 활용 계획 ⑥ 사진·이미지 자료 ⑦ 누락 항목 점검 — 이 7가지를 기준으로 점검하세요.', '하오커뮤니케이션은 항목별 작성 기준과 필수 포함 내용을 가이드합니다.'] },
  ...
  var DEFAULT_QNA = [
    ...
    { c: '수행기관', q: '하오커뮤니케이션은 어떤 분야 수행기관인가요?', a: '카탈로그·브로슈어·리플렛·패키지·다국어 홍보물 등 디자인·인쇄 분야 수행기관입니다. 수출·제조혁신·소상공인 사업의 디자인 서비스 카테고리에서 선택하실 수 있습니다.' },
    { c: '수행기관', q: '수행기관은 어떻게 선택하나요?', a: '바우처 시스템의 수행기관 검색에서 분야로 찾아 사용계획서에 등록합니다. 하오커뮤니케이션을 지정하시면 상담을 통해 결과물 방향을 함께 잡아드립니다.' },
    { c: '하오커뮤니케이션 문의', q: '신청 준비 단계부터 도움을 받을 수 있나요?', a: '네. 사업 이해부터 신청서·사용계획서 작성까지 가이드를 제공합니다. 컨설팅은 무료이며 접수 순으로 안내합니다.' },
    { c: '하오커뮤니케이션 문의', q: '어떤 제작물을 바우처로 만들 수 있나요?', a: '카탈로그·브로슈어·리플렛·패키지·라벨·다국어 홍보물 등 디자인 제작 항목이 메뉴판에 포함된 경우 활용 가능합니다. 사업별 가능 항목은 문의 시 확인해 드립니다.' },
    { c: '하오커뮤니케이션 문의', q: '결과보고서 작성도 안내받을 수 있나요?', a: '네. 항목별 작성 기준과 필수 포함 내용 가이드를 제공해 결과보고 완성도를 높이도록 돕습니다.' },
    { c: '하오커뮤니케이션 문의', q: '기업 부담금은 어느 정도인가요?', a: '사업·기업 유형에 따라 정부 지원 비율이 달라 총 사업비의 일부만 부담합니다. 정확한 비율은 해당 연도 공고 기준으로 안내드립니다.' },
    ...
    { c: '수행기관', q: '수행기관 정보는 어디서 조회하나요?', a: '바우처 시스템의 수행기관 검색에서 분야·기관명으로 조회할 수 있습니다. 하오커뮤니케이션도 디자인 분야로 검색됩니다.' },
    { c: '수행기관', q: '여러 수행기관을 동시에 이용할 수 있나요?', a: '서비스 분야가 다르면 여러 수행기관을 함께 이용할 수 있습니다. 디자인은 하오커뮤니케이션, 번역은 다른 기관 식으로 구성할 수 있습니다.' },
    { c: '수행기관', q: '결과물 방향은 수행기관과 어떻게 협의하나요?', a: '지정 후 수행기관과 사전 상담으로 콘셉트·범위·일정을 정합니다. 하오커뮤니케이션은 착수 전 방향 협의를 진행합니다.' },
    { c: '수행기관', q: '제작 기간은 보통 얼마나 걸리나요?', a: '결과물 종류·분량에 따라 다릅니다. 카탈로그·브로슈어는 보통 2~4주 내외이며, 협의 후 일정을 확정합니다.' },
    { c: '하오커뮤니케이션 문의', q: '상담은 어떻게 신청하나요?', a: '전화(1666-2027) 또는 누리집 문의하기로 신청하시면 담당자가 연락드립니다. 사업·결과물 종류를 알려주시면 더 빠르게 안내됩니다.' },
    { c: '하오커뮤니케이션 문의', q: '시안 수정은 몇 번까지 되나요?', a: '프로젝트 범위에 따라 정해진 횟수 안에서 시안·수정을 진행합니다. 착수 전 협의 단계에서 범위를 명확히 정합니다.' },
    { c: '하오커뮤니케이션 문의', q: '기존 로고·자료가 꼭 있어야 하나요?', a: '있으면 활용하고, 없으면 처음부터 함께 정리해 드립니다. 보유 자료(로고·제품 사진·문안)가 있으면 더 빠르게 진행됩니다.' },
    { c: '하오커뮤니케이션 문의', q: '지방·해외 기업도 진행할 수 있나요?', a: '네. 상담·진행은 비대면으로도 가능합니다. 자료 전달과 검수는 온라인으로 충분히 진행됩니다.' },
    { c: '하오커뮤니케이션 문의', q: '다국어(영문·중문) 제작도 되나요?', a: '네. 영문·중문 등 다국어 카탈로그·홍보물 제작이 가능합니다. 번역이 필요하면 번역 서비스와 연계해 진행합니다.' }
  ];
  ...
  var DEFAULT_SEO = {
    ...
    pages: {
      index: {
        title: "정부사업지원센터 | 하오커뮤니케이션 — 수출바우처·혁신바우처 디자인 수행기관",
        desc: "하오커뮤니케이션 정부사업지원센터. 수출바우처·제조혁신바우처·판로개척지원사업의 디자인·인쇄 수행기관 — 카탈로그·브로슈어·다국어 홍보물 제작을 지원합니다.",
        keywords: "수출바우처, 혁신바우처, 판로개척지원사업, 바우처 수행기관, 카탈로그 제작, 다국어 홍보물, 하오커뮤니케이션" },
      export: {
        title: "수출바우처 | 정부사업지원센터 — 하오커뮤니케이션",
        desc: "수출바우처 디자인 수행기관 하오커뮤니케이션. 신청 안내부터 다국어 카탈로그·브로슈어 제작·인쇄 감리까지 지원합니다.",
        keywords: "수출바우처, 수출바우처 신청, 다국어 카탈로그, 수출 브로슈어, 바우처 수행기관" },
      innovation: {
        title: "혁신바우처 | 정부사업지원센터 — 하오커뮤니케이션",
        desc: "제조 중소기업 혁신바우처 디자인 서비스. 진단부터 카탈로그·제품 소개서·패키지 제작까지 함께합니다.",
        keywords: "혁신바우처, 제조혁신바우처, 중소기업 혁신바우처, 디자인 바우처, 카탈로그 제작" },
      market: {
        title: "판로개척지원사업 | 정부사업지원센터 — 하오커뮤니케이션",
        desc: "판로개척지원사업 디자인·홍보물 제작. 상세페이지·카탈로그·리플렛·브랜딩으로 국내외 판로 확대를 돕습니다.",
        keywords: "판로개척지원사업, 소상공인 지원사업, 상세페이지, 카탈로그, 홍보물 제작" },
      column: {
        title: "칼럼 | 정부사업지원센터 — 하오커뮤니케이션",
        desc: "수출바우처·제조혁신바우처·소상공인 지원사업 신청 노하우와 일정, 결과보고 팁을 정리한 하오커뮤니케이션 정부사업지원센터 칼럼.",
        keywords: "수출바우처 칼럼, 바우처 신청 노하우, 결과보고서, 정부지원사업 팁" },
      qna: {
        title: "Q&A | 정부사업지원센터 — 하오커뮤니케이션",
  ...
  var DEFAULT_COPY = [
    ...
    { key: "vc_s1_line1", page: "index", sel: ".section1 .fill-text.line1", tag: "b", label: "프로젝트 — 문장①", value: "하오커뮤니케이션은 정부지원사업을 통해" },
    ...
    { key: "vc_s2_line1", page: "index", sel: ".section2 .fill-text.line1", tag: "b", label: "미션 — 문장①", value: "하오커뮤니케이션은 정부지원사업의 복잡한 절차를 대신하고," },
    ...
    { key: "vc_s7_t2", page: "index", sel: "#s-about .tit-box > h3:nth-of-type(2), #s-about .tit-box > h3:nth-of-type(4)", tag: "b", label: "소개 — 제목 2줄", value: "HAO COMMUNICATION" },
    { key: "vc_s7_line1", page: "index", sel: "#s-about .fill-text.line1", tag: "b", label: "소개 — 문장①", value: "하오커뮤니케이션은 6년 연속 정부지원사업 공식 디자인 수행기관으로, 412건 이상의 바우처 디자인을 수행했습니다." },
    ...
    { key: "ac_export_19", page: "export", sel: "#top > section:nth-of-type(3) > div > div:nth-of-type(4) > h3 > span", tag: "b", label: "[top] HAO COMMUNICATION", value: "HAO COMMUNICATION" },
    ...
    { key: "ac_export_49", page: "export", sel: "#timeline > div:nth-of-type(4) > p", tag: "b", label: "[timeline] 포털에서 필요한 서비스와 수행기관(하오커뮤니케이션", value: "포털에서 필요한 서비스와 수행기관(하오커뮤니케이션)을 선택합니다." },
    ...
    { key: "ac_market_10", page: "market", sel: "#top > section:nth-of-type(3) > div > div:nth-of-type(2) > h3 > span", tag: "b", label: "[top] HAO COMMUNICATION", value: "HAO COMMUNICATION" },
    ...
    { key: "ab_desc", page: "about", sel: ".subhero__desc", tag: "b", label: "상단 설명", value: "정부지원사업 디자인 수행부터 브랜드의 모든 비주얼까지 — 주식회사 하오커뮤니케이션입니다." },
    { key: "ab_who_t", page: "about", sel: "#top > section:nth-of-type(2) > h2", tag: "b", label: "WHO WE ARE — 제목", value: "하오커뮤니케이션은" },
    { key: "ab_who_p1", page: "about", sel: "#top > section:nth-of-type(2) > p:nth-of-type(2)", tag: "em", label: "회사소개 문단①", value: "**6년 연속 정부지원사업 공식 디자인 수행기관**입니다. 수출바우처·제조혁신바우처·판로개척지원사업에서 412건 이상의 디자인 프로젝트를 수행하며, 중소·중견기업의 해외 진출과 판로 개척을 디자인으로 지원해 왔습니다." },
    { key: "ab_who_p2", page: "about", sel: "#top > section:nth-of-type(2) > p:nth-of-type(3)", tag: "em", label: "회사소개 문단②", value: "동시에 카탈로그·브로슈어 같은 인쇄 디자인부터 홈페이지 구축, 제품·공간 촬영, 온라인 마케팅까지 — 기업에 필요한 모든 비주얼 커뮤니케이션을 **4개 전문 센터**가 원스톱으로 해결합니다. 만드는 곳과 알리는 곳이 달라 생기는 비효율 없이, 하나의 팀이 처음부터 끝까지 책임집니다." },
    { key: "ab_num_t", page: "about", sel: "#top > section:nth-of-type(3) > h2", tag: "b", label: "NUMBERS — 제목", value: "숫자로 보는 하오커뮤니케이션" },
    { key: "ab_ctr_t", page: "about", sel: "#top > section:nth-of-type(4) > h2", tag: "b", label: "OUR CENTERS — 제목", value: "4개 전문 센터" },
    { key: "ab_ctr_lead", page: "about", sel: "#top > section:nth-of-type(4) > p:nth-of-type(2)", tag: "b", label: "센터 소개 리드", value: "각 분야 전문 조직이 독립 사이트로 운영됩니다. 필요한 센터로 바로 이동하세요." },
    { key: "ab_info_t", page: "about", sel: "#top > section:nth-of-type(5) > h2", tag: "b", label: "COMPANY INFO — 제목", value: "회사 정보" },
    { key: "ab_contact_t", page: "about", sel: "#contact .contact__title", tag: "b", label: "문의 — 제목", value: "어떤 프로젝트든,\n하오와 시작하세요" },
    { key: "ab_contact_d", page: "about", sel: "#contact .contact__desc", tag: "b", label: "문의 — 설명", value: "지원사업 신청부터 디자인·웹·촬영·마케팅까지\n담당자가 확인 후 빠르게 연락드립니다." },
