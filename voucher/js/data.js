...
(function () {
  ...
  var DEFAULT_COPY = [
    ...
    { key: "ac_export_03", page: "export", sel: "#top > section:nth-of-type(2) > p:nth-of-type(2) > em", tag: "b", label: "[top] 자사의 수출역량에 맞는 수출지원 서비스를 자", value: "자사의 수출역량에 맞는 수출지원 서비스를 자유롭게 선택" },
    ...
    { key: "ac_export_54", page: "export", sel: "#contact > div > div > p:nth-of-type(1)", tag: "b", label: "[contact] VOUCHER CONSULTING", value: "VOUCHER CONSULTING" },
    { key: "ac_export_55", page: "export", sel: "#contact > div > div > h2", tag: "b", label: "[contact] 바우처, 어디서시작할지 막막하다면?", value: "바우처, 어디서\n시작할지 막막하다면?" },
    { key: "ac_export_56", page: "export", sel: "#contact > div > div > p:nth-of-type(2)", tag: "b", label: "[contact] 신청 가능 여부부터 무료로 확인해 드립니다.", value: "신청 가능 여부부터 무료로 확인해 드립니다.\n담당자가 확인 후 빠르게 연락드립니다." },
    ...
    { key: "ac_innovation_03", page: "innovation", sel: "#top > section:nth-of-type(2) > p:nth-of-type(2) > em", tag: "b", label: "[top] 진단을 통한 기업 특성별 맞춤형 지원", value: "진단을 통한 기업 특성별 맞춤형 지원" },
    ...
    { key: "ac_innovation_42", page: "innovation", sel: "#contact > div > div > p:nth-of-type(1)", tag: "b", label: "[contact] VOUCHER CONSULTING", value: "VOUCHER CONSULTING" },
    { key: "ac_innovation_43", page: "innovation", sel: "#contact > div > div > h2", tag: "b", label: "[contact] 바우처, 어디서시작할지 막막하다면?", value: "바우처, 어디서\n시작할지 막막하다면?" },
    { key: "ac_innovation_44", page: "innovation", sel: "#contact > div > div > p:nth-of-type(2)", tag: "b", label: "[contact] 신청 가능 여부부터 무료로 확인해 드립니다.", value: "신청 가능 여부부터 무료로 확인해 드립니다.\n담당자가 확인 후 빠르게 연락드립니다." },
    ...
    { key: "ac_market_03", page: "market", sel: "#top > section:nth-of-type(2) > p:nth-of-type(2) > em", tag: "b", label: "[top] 새로운 판로를 개척하고 매출을 확대", value: "새로운 판로를 개척하고 매출을 확대" },
    ...
    { key: "ac_market_36", page: "market", sel: "#contact > div > div > p:nth-of-type(1)", tag: "b", label: "[contact] VOUCHER CONSULTING", value: "VOUCHER CONSULTING" },
    { key: "ac_market_37", page: "market", sel: "#contact > div > div > h2", tag: "b", label: "[contact] 바우처, 어디서시작할지 막막하다면?", value: "바우처, 어디서\n시작할지 막막하다면?" },
    { key: "ac_market_38", page: "market", sel: "#contact > div > div > p:nth-of-type(2)", tag: "b", label: "[contact] 신청 가능 여부부터 무료로 확인해 드립니다.", value: "신청 가능 여부부터 무료로 확인해 드립니다.\n담당자가 확인 후 빠르게 연락드립니다." },
    ...
    { key: "ac_column_02", page: "column", sel: "#contact > div > div > p:nth-of-type(1)", tag: "b", label: "[contact] VOUCHER CONSULTING", value: "VOUCHER CONSULTING" },
    { key: "ac_column_03", page: "column", sel: "#contact > div > div > h2", tag: "b", label: "[contact] 바우처가궁금하신가요?", value: "바우처가\n궁금하신가요?" },
    { key: "ac_column_04", page: "column", sel: "#contact > div > div > p:nth-of-type(2)", tag: "b", label: "[contact] 신청 가능 여부부터 무료로 확인해 드립니다.", value: "신청 가능 여부부터 무료로 확인해 드립니다.\n담당자가 확인 후 빠르게 연락드립니다." },
